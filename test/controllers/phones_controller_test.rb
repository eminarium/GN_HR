...
class PhonesControllerTest < ActionController::TestCase
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post :create, phone: { employee_id: @phone.employee_id, notes: @phone.notes, phone_no: @phone.phone_no, phone_type_id: @phone.phone_type_id }
    end
  ...
  test "should update phone" do
    patch :update, id: @phone, phone: { employee_id: @phone.employee_id, notes: @phone.notes, phone_no: @phone.phone_no, phone_type_id: @phone.phone_type_id }
    assert_redirected_to phone_path(assigns(:phone))
  end
