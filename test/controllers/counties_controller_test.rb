...
class CountiesControllerTest < ActionController::TestCase
  ...
  test "should create county" do
    assert_difference('County.count') do
      post :create, county: { county_name: @county.county_name, notes: @county.notes, state_id: @county.state_id }
    end
  ...
  test "should update county" do
    patch :update, id: @county, county: { county_name: @county.county_name, notes: @county.notes, state_id: @county.state_id }
    assert_redirected_to county_path(assigns(:county))
  end
